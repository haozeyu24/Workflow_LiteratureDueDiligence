...
- declared method classes for retrieval: visual-language-model-based document understanding; OCR plus layout parsing; rule-based PDF parsers; table-structure recognition; layout-aware transformers; multimodal document AI; non-visual LLM or NLP extraction from converted text; hybrid PDF extraction systems; benchmark and tool-comparison studies.
