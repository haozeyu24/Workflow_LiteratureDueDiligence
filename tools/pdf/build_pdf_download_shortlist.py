...
def classify(
    ...
    if promotion != "advance_to_import":
        return {
            ...
            "shortlist_decision": "do_not_request",
            "evidence_category": "noise",
            "learned_criteria_matched": "not advanced by abstract triage second pass",
            "shortlist_rationale": "Do not request PDF: paper was not advanced to full-text import by abstract triage second pass.",
        }
...
def main() -> int:
    if len(sys.argv) != 2:
        print("Usage: python3 tools/pdf/build_pdf_download_shortlist.py <run_id>")
        return 1
    ...
    for queue_row in queue_rows:
        ...
        base = {
            ...
            "second_pass_decision": review2.get("second_pass_decision", ""),
        ...
        output_rows.append(
            {
                ...
                "second_pass_decision": base["second_pass_decision"],
